        ...
        <table class="table table-hover table-inner-border" style="table-layout: fixed;width: 100%;">
            ...
            <c:forEach items="${pageInfo.list}" var="account" varStatus="s">
                <tr>
                    ...
                    <td>
                        <button class="btn-sm btn-warning" onclick="window.location.href = '${pageContext.request.contextPath}/account/update.do?id=${account.id}&condition=${condition}'">修改</button>
